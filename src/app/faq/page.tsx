  ...
  return (
    <>
      <div className="bg-[url(/tours/images/banner.png)] bg-no-repeat bg-center md:bg-cover h-[25rem] md:h-[43.75rem] relative">
        ...
        />
        <div className="relative z-10 flex md:flex-row flex-col justify-center items-center px-[1rem] md:px-[5rem] pt-[12rem]">
          <div className="">
      ...
      <div className="relative h-full w-full">
        ...
        />
        <div className="px-[5rem] z-20 relative">
          <div className="mt-[2.9375rem] ">
            <h2 className="text-[1.125rem] font-extrabold text-[#262626]/40">
              FAQs
            </h2>
            <h1
            ...
            <p className="mt-[2rem] text-[#6A6A6A] font-bold w-[38.8125rem]">
