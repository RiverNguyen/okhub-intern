...
const Ethical = () => {
  ...
  return (
    <div className="relative w-full h-[52.175rem] flex items-center">
      <svg
      ...
      <div className="mt-[3.5rem] flex justify-between items-center px-[1rem] md:px-[5rem] w-full relative z-30">
        <div>
