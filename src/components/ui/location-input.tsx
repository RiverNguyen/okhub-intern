      ...
      <Popover open={openCountryDropdown} onOpenChange={setOpenCountryDropdown}>
        <PopoverTrigger asChild>
          <Button
            ...
            disabled={disabled}
            className="w-full justify-between bg-transparent hover:bg-transparent border-b-[#BBD3C8] border-b rounded-none"
          >
            {selectedCountry ? (
              ...
              <span className="text-[#BBD3C8]/50">Select country</span>
            )}
        ...
        <PopoverContent className="w-[300px] p-0">
          <Command>
            ...
            <CommandList className="hidden-y-scroll">
