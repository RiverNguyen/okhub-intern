        ...
        <AccordionContent>
          <div className="pb-4 text-[1rem] md:text-[0.85rem] tracking-0.0125 text-[#6A6A6A] pt-[1rem]">
            <div className="*:text-[1rem] md:*:text-[0.85rem] *:tracking-0.0125 *:text-[#6A6A6A]">
              ...
              <ul>
                <li>
                  <strong>Motorbike Rental</strong>: Semi-automatic bikes with
                  fuel.
                </li>
                <li>
                ...
                <li>
                  <strong>Meals</strong>: Breakfast, lunch, and dinner during
                  the tour.
                </li>
                <li>
                ...
                <li>
                  <strong>Safety Gear</strong>: Helmets and protective clothing.
                </li>
                <li>
                  <strong>Entrance Fees</strong>: For attractions and landmarks
                  on the route.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  <strong>Personal Expenses</strong>: Snacks, drinks, souvenirs.
                </li>
                <li>
            ...
            <div className="*:text-[1rem] md:*:!text-[0.875rem] *:tracking-0.0125 *:text-[#6A6A6A]">
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      Share your desired tour dates, number of travelers, and
                      any specific requirements (e.g., dietary needs,
